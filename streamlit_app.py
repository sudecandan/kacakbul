...
if st.button("📊 **Tesisatları Sırala**"):
    ...
    # 📌 **Admin tarafından yüklenen en güncel dosyaları kullan**
    ...
    # Şüpheli tesisatlar yerine sistemde kayıtlı tüm tesisatları işleme alıyoruz
    for tesisat in sektor_dict.keys():
